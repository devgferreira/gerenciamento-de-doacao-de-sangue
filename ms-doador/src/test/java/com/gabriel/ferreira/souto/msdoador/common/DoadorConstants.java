...
public class DoadorConstants {
    public static final Doador DOADOR_VALIDO = new Doador("82116296072", "Gabriel", "gabrie@gmail.com",
            new Date(), Genero.M, 60, "B-");
    public static final DoadorRequestDTO DOADOR_REQUEST_DTO_VALIDO = new DoadorRequestDTO("82116296072", "Gabriel", "gabrie@gmail.com",
            new Date(), Genero.M, 60, "B-",new EnderecoDTO("Vila Maria", "SP", "SP", "02128020"));
    public static final DoadorResponseDTO DOADOR_RESPONSE_DTO_VALIDO = new DoadorResponseDTO("82116296072", "Gabriel", "gabrie@gmail.com",
            new Date(), Genero.M, 60, "B-",new EnderecoDTO("Vila Maria", "SP", "SP", "02128020"));
